...
URL: https://edabit.com/challenge/GwCAximybWF6ANdLY

"""


def pie_chart(dicio):
    valorPadrao = (360/sum(list(dicio.values())))
    for letra in dicio.keys():
        dicio[letra] = round(dicio[letra] * valorPadrao, 1)
    return dicio
